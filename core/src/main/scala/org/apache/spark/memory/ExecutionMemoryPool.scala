...
private[memory] class ExecutionMemoryPool(
  ...
  /**
    ...
    *
    *
    * 假设当前有N个线程，必须保证每个线程在溢出之前至少获得1/2N的内存，并且每个线程最多获得1/N的内存。由于N是动态变化的
    * 变量，所有要持续对这些线程进行跟踪，以便于线程的数量发生变化时，重新按照1/2N和1/N计算
    *
